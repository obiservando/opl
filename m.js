...
{cat:"",titulo:"<button id=\"norobot\" type=\"button\" onclick=\"$('.detailSeta').click();int=setInterval(function(){$('.post:has(.user-9458-avatar,.user-7268-avatar,#norobot)').hide()},3000)\" >Clique aqui para ocultar robôs Barbara e Juca</button>",metas:"",url:"",img:"http://i.imgur.com/sbaWUoQs.jpg",p:0},
